...
noise_data = np.load('standard_deviation_planet_spectrum.npy')
spectrum_data = np.load('planet_atmosphere_spectrum_data.npy')
...
def search_for_light(name = "N2O", line = 2870):
    temp_range = [150, 450]
