...
def fuel_needed_for_deltav(init_mass, deltav):
...
escape_velocity = (10789.272032602184) * ms_to_AUyr  #+  0.0999#0.100680 #0.10070DENNNNNNNE #0.10112DENNE  #11269 m/s
...
initial_satellite_velocity = np.array([1.98825741,  6.58785222]) + 0.1#+ 0.09806 * launch_angle_unit_vector
...
def boost(sat_mass, deltav, current_vel):
    new_sat_mass = sat_mass - fuel_needed_for_deltav(deltav)
