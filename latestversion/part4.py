...
def get_satellite_velocity(shift1, shift2):
    """
    ...
    """
    placeholder_lambda1, placeholder_lambda2 = shift1, shift2
...
def test_velocity_finder():
    tolerance = 1e-6
    shift_refstar_1, shift_refstar_2 = -0.002651878563*1e-9, 0.008295625752*1e-9
    refstar_1_radial, refstar_2_radial = get_radial_velocities(-0.002651878563*1e-9, 0.008295625752*1e-9)

    # case 1
    sat_relative_refstar_1, sat_relative_refstar_2 = get_radial_velocities(shift_refstar_1, shift_refstar_2)

    # case 2
    _sat_relative_refstar_1, _sat_relative_refstar_2 = get_radial_velocities(0, 0)

    success = (_sat_relative_refstar_1==0 and _sat_relative_refstar_2==0 and (abs(sat_relative_refstar_1 - refstar_1_radial) < tolerance) and (abs(sat_relative_refstar_2 - refstar_2_radial) < tolerance))
    assert success

#test_velocity_finder()
